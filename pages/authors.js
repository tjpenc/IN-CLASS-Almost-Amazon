  ...
  array.forEach((item) => {
    ...
    <div class="card" style="width: 18rem;">
      <div class="card-body">
        ...
        <p class="card-text bold">${item.favorite ? '<span class="badge badge-info sale-badge" style="background-color:silver;"><i class="fa fa-star" aria-hidden="true" style="color:yellow;"></i> Favorite</span>' : ''}</p>
        <hr>
